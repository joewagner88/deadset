...
class SetlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setlist" do
    assert_difference('Setlist.count') do
      post setlists_url, params: { setlist: { encore: @setlist.encore, number: @setlist.number } }
    end
  ...
  test "should update setlist" do
    patch setlist_url(@setlist), params: { setlist: { encore: @setlist.encore, number: @setlist.number } }
